...
* "node-exif":http://github.com/gomfunkel/node-exif -- Library to extract Exif metadata from images
...
* "calais":http://github.com/mcantelon/node-calais -- Semantically analyze text using the Calais web service
...
* "node-c2dm":http://github.com/SpeCT/node-c2dm -- A library to send messages using the Android Cloud to Device Messaging (C2DM) service.
...
* "ranger":http://github.com/mrduncan/ranger/ -- A simple library which wraps Campfire's API
...
* "fiberize":http://github.com/lm1/node-fiberize -- Node API wrapper for use with fibers.
* "fibers":https://github.com/laverdet/node-fibers -- The closest thing to a thread you'll find in Javascript
* "fibers-promise":http://github.com/lm1/node-fibers-promise -- Small yet powerful promises based on fibers.
...
* "node_memo":http://github.com/akidee/node_memo -- Asynchronous function memoization
...
* "sexy":http://github.com/crabdude/sexy -- Proxy (ES5) for writing sequential asynchronous code in a synchronous style
...
* "deja":http://github.com/mcantelon/node-deja -- CLI utility for managing git versioning of dotfiles and such
* "daemonchk.js":https://github.com/dulac/daemonchk.js/ -- Daemon Monitor (with HTTP interface)
* "dir2html":http://github.com/mcantelon/node-dir2html -- Render a directory as HTML
...
* "node-discount":http://github.com/visionmedia/node-discount -- C markdown parser "discount" bindings
* "node-downloader":http://github.com/rabc/node-downloader -- Downloader module for node.js
...
* "node-gnomenotify":http://github.com/bodil/node-gnomenotify -- C++ bindings for GNOME libnotify on-screen notifications
